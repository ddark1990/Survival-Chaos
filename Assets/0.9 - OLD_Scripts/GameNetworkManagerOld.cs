...
namespace SurvivalChaos
{
    public class GameNetworkManagerOld : NetworkManager
    {
        ...
        public NetworkPlayerOLD localRoomPlayerRef;

        public bool gameInProgress;

        public List<NetworkPlayerOLD> players;
        [Header("Races")]
        ...
        public override void OnClientDisconnect(NetworkConnection conn)
        {
            ...
            var player = conn.identity.GetComponent<NetworkPlayerOLD>();
...
*/
        ...
        private void SpawnPlayerBase(NetworkPlayerOLD player)
        {
            /*//randomize
        ...
        private void OnCreateNetworkRoomPlayer(NetworkConnection conn, CreateNetworkRoomPlayerMessage message)
        {
            ...
            var roomPlayer = roomPlayerObject.GetComponent<NetworkPlayerOLD>();
