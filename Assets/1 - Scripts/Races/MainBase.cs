...
namespace SurvivalChaos 
{
    public class MainBase : Selectable
    {
        ...
        {
            //randomize
            var startPosition = NetworkManager.startPositions[localPlayer.playerId];
            ...
            foreach (var turretSpawn in baseSpawn.turretSpawns)
            {
                ...
                turret.ServerSetMaterialIndex(localPlayer.playerId);

                turret.ServerSetMainBaseOwner(localPlayer.playerId);
            ...
            foreach (var barrackSpawn in baseSpawn.barrackSpawns)
            {
                ...
                barracks.ServerSetMaterialIndex(localPlayer.playerId);

                barracks.ServerSetMainBaseOwner(localPlayer.playerId);
        ...
        public override void OnStartClient()
        {
            ...
            localPlayer = owner.GetComponent<RoomPlayer>();
