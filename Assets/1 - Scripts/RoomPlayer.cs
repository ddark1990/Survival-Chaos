...
namespace SurvivalChaos
{
    public class RoomPlayer : NetworkBehaviour
    {
        ...
        public static event Action<RoomPlayer> ClientOnDisconnected;

        public static event Action<RoomPlayer> ClientOnInfoUpdated;
        ...
        public override void OnStartServer()
        {
            ...
            var playerColor = colorArray[playerId];
        ...
        {
            var startPosition = NetworkManager.startPositions[playerId];
